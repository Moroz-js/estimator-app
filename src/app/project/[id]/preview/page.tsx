...
export default function ProjectPreviewPage() {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        ...
        if (!data.is_public) throw new Error("Проект не доступен для просмотра");
  ...
  return (
    <div className="viewport">
      <div className="card animate-in" style={{ width: "100%", maxWidth: 1280 }}>
        <div className="card-header">
        ...
        <div className="grid" style={{ marginBottom: 24 }}>
          ...
          <div>
            ...
            <div style={{ display: "flex", gap: 12 }}>
              <span>BA: {hoursByType.BA} ч</span>
              <span>NC: {hoursByType.NC} ч</span>
              <span>DE: {hoursByType.DE} ч</span>
              <span style={{ fontWeight: 600 }}>Всего: {totalHours} ч</span>
            </div>
          </div>
        </div>
